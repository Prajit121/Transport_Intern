...
"[project]/src/components/PUCC.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var PUCC = function() {
    ...
    var _useState2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('All'), 2), selectedVehicleCategory = _useState2[0], setSelectedVehicleCategory = _useState2[1];
    ...
    var totals = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PUCC.useMemo[totals]": function() {
            return {
                totalApplications: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$dummyData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].puccData.reduce({
                    "PUCC.useMemo[totals]": function(sum, d) {
                        return sum + d.totalApplications;
                    }
                }["PUCC.useMemo[totals]"], 0),
                totalPUCCs: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$dummyData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].puccData.reduce({
                    "PUCC.useMemo[totals]": function(sum, d) {
                        return sum + d.grandTotal;
                    }
                }["PUCC.useMemo[totals]"], 0),
                totalFees: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$dummyData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].puccData.reduce({
                    "PUCC.useMemo[totals]": function(sum, d) {
                        return sum + d.feesRealized;
                    }
                }["PUCC.useMemo[totals]"], 0),
                totalLateFees: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$dummyData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].puccData.reduce({
                    "PUCC.useMemo[totals]": function(sum, d) {
                        return sum + d.lateFeeRealized;
                    }
                }["PUCC.useMemo[totals]"], 0),
                totalDefaulters: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$dummyData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].puccData.reduce({
                    "PUCC.useMemo[totals]": function(sum, d) {
                        return sum + (d.totalVehicles - d.grandTotal);
                    }
                }["PUCC.useMemo[totals]"], 0)
            };
        }
    ...
    var districts = [
        'All'
    ].concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_to_consumable_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(new Set(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$dummyData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].puccData.map(function(d) {
        return d.district;
    }))));
    var vehicleCategories = [
        'All'
    ].concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_to_consumable_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(new Set(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$dummyData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].puccData.map(function(d) {
        return d.vehicleCategory;
    }))));
    // Filter data
    var comparisonProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useComparison$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useComparison"])({
        ...
        getYearDataOptions: {
            '2024': __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$dummyData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].puccData || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$dummyData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].puccData2026,
            '2025': __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$dummyData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].puccData,
            '2026': __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$dummyData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].puccData2026
        }
    });
    ...
    var scaledPrimaryData = scaledPrimaryDataRaw.filter(function(row) {
    ...
    var categories = [
        ...
        {
            id: 'freshWithoutLateFee',
            label: 'PUCC Issued on Time'
        },
        {
            id: 'freshWithLateFee',
            label: 'PUCC Issued with Late Fee'
        },
        {
            id: 'grandTotal',
            label: 'Grand Total PUCC'
        },
        {
            id: 'feesRealized',
            label: 'PUCC Fees'
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: totals.totalDefaulters.toLocaleString()
                            }, void 0, false, {
                                fileName: "[project]/src/components/PUCC.js",
                                lineNumber: 114,
                                columnNumber: 21
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-xs text-gray-500 dark:text-gray-400 mt-1",
                                children: "Pending PUCC renewals"
                            }, void 0, false, {
                                fileName: "[project]/src/components/PUCC.js",
                                lineNumber: 115,
                                columnNumber: 21
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                        ...
                                        onChange: function(e) {
                                            return setSelectedVehicleCategory(e.target.value);
                                        },
                                        className: "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500",
                                        children: vehicleCategories.map(function(category) {
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                value: category,
                                                children: category
                                            }, category, false, {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: [
                                                'feesRealized',
                                                'lateFeeRealized'
                                            ].includes(compareCategory) ? formatCurrency(valPrimary) : valPrimary.toLocaleString()
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/PUCC.js",
                                            lineNumber: 211,
                                            columnNumber: 41
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: [
                                                'feesRealized',
                                                'lateFeeRealized'
                                            ].includes(compareCategory) ? formatCurrency(valComparison) : valComparison.toLocaleString()
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/PUCC.js",
                                            lineNumber: 214,
                                            columnNumber: 41
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: [
                                                ...
                                                [
                                                    'feesRealized',
                                                    'lateFeeRealized'
                                                ].includes(compareCategory) ? formatCurrency(variance) : variance.toLocaleString()
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/components/PUCC.js",
                                            lineNumber: 217,
                                ...
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Fragment, {
                                    children: [
                                        ...
                                        isExpanded && districtData.filter(function(row) {
                                            return selectedVehicleCategory === 'All' || row.vehicleCategory === selectedVehicleCategory;
                                            ...
                                            }, "".concat(district, "-").concat(row.vehicleCategory), true, {
                                                fileName: "[project]/src/components/PUCC.js",
                                                lineNumber: 325,
                                                columnNumber: 45
                                            }, _this);
...
_s(PUCC, "0AvDylpdwHO8XCnI6/akRaisL0Y=", false, function() {
    return [
...
_c = PUCC;
const __TURBOPACK__default__export__ = PUCC;
var _c;
__turbopack_context__.k.register(_c, "PUCC");
if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_type_of$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(globalThis.$RefreshHelpers$) === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_51e6a790._.js.map