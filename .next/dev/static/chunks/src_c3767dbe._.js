...
var Vehicles = function() {
    ...
    var filteredData = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$dummyData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].vehicleRegistrations.filter(function(d) {
        ...
        datasets: [
            {
                ...
                data: filteredData.map(function(d) {
                    return d.cars + d.bikes + d.trucks;
                }),
    ...
    var totals = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Vehicles.useMemo[totals]": function() {
            return {
                cars: filteredData.reduce({
                    "Vehicles.useMemo[totals]": function(sum, d) {
                        return sum + d.cars;
                    }
                }["Vehicles.useMemo[totals]"], 0),
                bikes: filteredData.reduce({
                    "Vehicles.useMemo[totals]": function(sum, d) {
                        return sum + d.bikes;
                    }
                }["Vehicles.useMemo[totals]"], 0),
                trucks: filteredData.reduce({
                    "Vehicles.useMemo[totals]": function(sum, d) {
                        return sum + d.trucks;
                    }
                }["Vehicles.useMemo[totals]"], 0),
...
//# sourceMappingURL=src_c3767dbe._.js.map